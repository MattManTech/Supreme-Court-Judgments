...
class VerdictProcessor:
    ...
    def __init__(self, data_dir="/home/yuval/Desktop/nlp/data2", query_data_dir="pdfs",
                 query_processed_data_dir="csv") -> None:
    ...
    async def area_spliting(self, text: str, id: int):
        ...
        judges_and_team1_splitter[0] = \
        judges_and_team1_splitter[0].split(":")[:len(judges_and_team1_splitter[0].split(":")) - 1][0]
